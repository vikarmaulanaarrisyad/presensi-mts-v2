...
<head>
    ...
    <title>Portal Siswa - MTs Mambaul Ulum</title>
...
<!-- Profile Banner -->
    <div class="profile-banner">
        ...
        <div class="profile-info">
            ...
            <h1 class="profile-name">{{ $siswaData->name }}</h1>
            <div class="d-flex gap-3 flex-wrap mt-3">
                <div class="badge-info">
                    <i class="fa-regular fa-id-badge" style="color: #6ee7b7;"></i> NIS: {{ $siswaData->nis }}
                </div>
                <div class="badge-info">
                    <i class="fa-solid fa-chalkboard-user" style="color: #93c5fd;"></i> Kelas: {{ $siswaData->kelas }}
                </div>
            </div>
        </div>
        <div class="sensor-status">
            <div style="font-size: 0.7rem; text-transform: uppercase; letter-spacing: 1.5px; color: rgba(255,255,255,0.5); font-weight: 700; margin-bottom: 8px;">Status Sensor Jari</div>
            @if($siswaData->fingerprint_id)
                <div style="background: rgba(16, 185, 129, 0.2); border: 1px solid rgba(16, 185, 129, 0.4); color: #34d399; padding: 10px 20px; border-radius: 12px; font-weight: 700; font-size: 0.85rem; display: inline-block; box-shadow: 0 0 20px rgba(16,185,129,0.2);">
                    <i class="fa-solid fa-check-circle me-1"></i> JARI TERDAFTAR
                </div>
            @else
                <div style="background: rgba(239, 68, 68, 0.2); border: 1px solid rgba(239, 68, 68, 0.4); color: #f87171; padding: 10px 20px; border-radius: 12px; font-weight: 700; font-size: 0.85rem; display: inline-block;">
                    <i class="fa-solid fa-triangle-exclamation me-1"></i> BELUM TERDAFTAR
                </div>

            @endif
            <div class="mt-3">
                <button class="btn btn-light rounded-pill px-4 py-2" style="font-weight: 700; font-size: 0.85rem; color: #0f172a; box-shadow: 0 4px 15px rgba(255,255,255,0.2);" data-bs-toggle="modal" data-bs-target="#modalIzinSiswa">
                    <i class="fa-solid fa-paper-plane me-1"></i> Ajukan Izin / Sakit
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4 mt-2">
        <div class="col-md-4">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    <div class="stat-val">{{ $totalHadirKu }}</div>
        ...
        <div class="col-md-4">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    <div class="stat-val">{{ $totalIzinKu }}</div>
        ...
        <div class="col-md-4">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    <div class="stat-val">{{ $totalAlpaKu }}</div>
...
<div class="modal fade" id="modalIzinSiswa" tabindex="-1" aria-hidden="true">
